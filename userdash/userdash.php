...
<?php
$q = "select credits, reputation, email from members where u_id = ".$_SESSION['uid'];
...
<body>
	...
	<div style="height:80;">
		<div class="text1" style="margin:0 0 0 10;display:block;float:left">Email: <?php echo $result["email"]; ?></div>
	</div>
</body>